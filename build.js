...
.intimacy-link{display:block;margin:0 0 18px;padding:9px 10px;border:1px solid #4b5563;border-radius:6px;color:#e9d5ff;text-decoration:none;font-size:.76rem;line-height:1.4;background:#24202f;transition:all .15s}.intimacy-link:hover{border-color:#a78bfa;background:#302545;color:#fff}
...
<a class="intimacy-link" href="./intimacy/" target="_blank" rel="noopener">✦ 情侣亲密测试<br><small>匿名 · 30 道题 · 可做伴侣对照</small></a>
